...
public class DemoDate {
  public static void main(String[] args) {
    ...
    // because it is hard to perform opearation on "date", i.e. comparison? add day?
    ...
    System.out.println(LocalDate.of(2016,1,25).getDayOfYear()); //25
    System.out.println(LocalDate.of(2016,1,18).getDayOfMonth()); //18
