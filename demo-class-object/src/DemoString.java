...
public class DemoString {
  ...
  public static void main(String[] args) {
    ...
    s1 = s1 + "???"; // s1-> hello???
    // so, at this moment, we got3 String objects i memory (hello, hellowrold, hello???)
    // "hello" object will be collected by JVN (Auto-GC)
    ...
    BigDecimal bd = BigDecimal.valueOf(1.0); // add, substract, multiply, divide
